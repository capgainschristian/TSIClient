...
setup(
  ...
  url = 'https://github.com/capgainschristian/TSIClient',   # Provide either the link to your github or to your website
  #download_url = 'https://github.com/capgainschristian/TSIClient/archive/v_0.7.tar.gz',    # If you create releases through Github, then this is important
